...
func TestStripForSpeech(t *testing.T) {
	tests := []struct {
		...
		{"double bold", "Hello **World**", "Hello World"},
		{"triple bold", "Hello ***World***", "Hello World"},
		{"italic", "Hello _World_", "Hello World"},
		{"double italic", "Hello __World__", "Hello World"},
		...
		{"bullet", "- Item one\n- Item two", "Item one\nItem two"},
		{"fence", "```\ncode\nblock```", "code\nblock"},
		{"link", "See [here](https://example.com)", "See here"},
